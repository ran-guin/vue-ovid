<template lang='pug'>
  span.schedule-section
    ...
    Block(title="Scheduled Vaccines" subheader="[available to staff]" :trigger="toggleMe" :data="scheduled" :data_options="data_options" :alt="alt_help")
  ...
  export default {
    ...
    data () {
      return {
        ...
        alt_help: '<b>nothing scheduled</b><p ><UL><LI>Schedule Specific Vaccines for Immunization</LI><LI>Search for Vaccines</LI><LI>Check for Side-effects / Contra-indications</LI></UL>',
        gs: true
      }
    },
    props: {
